...
export const MessageInput = () => {
  ...
  const wrapperRef = useRef(null); // ✅ CHANGED: wrapper for click detection
  ...
  // ✅ CHANGED: handle outside click to close emoji picker
  useEffect(() => {
